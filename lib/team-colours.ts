...
/**
 * Abbreviation -> primary kit colour. Derived from lib/clubs.ts so a promoted
 * club cannot end up without a colour.
 */
export const TEAM_COLOURS: Record<string, string> = Object.fromEntries(
  CLUBS.map((club) => [club.abbr, club.colour])
);
